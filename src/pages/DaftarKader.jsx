  ...
  return (
    ...
    <div className="klogin-container">
      <div className="klogin-form-wrapper">
        ...
        {error && <div className="kerror-message" style={{color: 'red', marginBottom: '10px', padding: '10px', border: '1px solid red', borderRadius: '4px', backgroundColor: '#ffe6e6'}}>{error}</div>}
        ...
        <form onSubmit={handleSubmit} className="klogin-form">
          ...
          <button type="submit" className="kbutton" disabled={loading}>
